    ...
    return (
        <>
            <div className="w-[100%] flex justify-center px-2 sm:px-6 lg:px-8 py-6">
                <div className={`w-[100%] relative lg:w-[60%] md:w-[80%] ${isDark ? 'dark:bg-gray-800' : 'bg-white'
                            ...
                            <div className="">
                                ...
                                >
                                    ...
                                    <div className="flex items-center  gap-4">
                                        <h3 className="md:text-lg text-sm font-semibold dark:text-gray-100 text-gray-700">Quantity:</h3>
                                        <div className="flex items-center border rounded-md">
                                            <button
                                                onClick={() => handleQuantityChange(-1)}
                                                disabled={quantityNum <= 1}
                                                className="px-3 py-2 text-gray-600 dark:text-gray-100 disabled:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700"
                                            >
                                                <FaMinus />
                                            </button>
                                            <span className="px-4 py-2 dark:text-gray-100 text-gray-800">{quantityNum}</span>
                                            <button
                                                onClick={() => handleQuantityChange(1)}
                                                className="px-3 py-2 text-gray-600 dark:text-gray-100 hover:bg-gray-100 dark:hover:bg-gray-700"
                                            >
                                                <FaPlus />
                                            </button>
                                        </div>
                                                ...
                                                <div className="grid md:grid-cols-2 md:grid-col-1 gap-4 w-[100%] ">
                                                    {customizableOption && customizableOption?.length > 0 ?
                                                        ...
                                                        customizableOption.map((field, index) => (
                                                            <div
                                                                key={index}
                                                                className={`flex flex-col ${field?.selectedField === "file" ? "col-span-2" : ""} `}
                                                            >
